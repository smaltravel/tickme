...
Widget buildTickCategoryDialog(
  ...
  final nameController = TextEditingController(
      text: currentCategory.id != null ? currentCategory.name : '');
      ...
      content: Column(
        ...
        children: <Widget>[
          ...
          IconPickerCard(
            ...
            onIconSelected: (icon) =>
                setState(() => currentCategory = currentCategory.copyWith(
                      icon: icon,
          ...
          TextField(
            ...
            decoration:
                InputDecoration(labelText: context.loc.home_edit_category_name),
          ),
          const SizedBox(height: AppConstants.defaultSizedBox),
          ColorPickerCard(
            color: currentCategory.color,
